...
echo "<u><b> Array Rules12</b></u><br> ";
$captcha ='Hello ghh World';
var_dump(stripos($captcha,'world')) ;
echo"<br>";


echo "<u><b> Array Rules13</b></u><br> ";
$captcha ='Hello World';
...
echo "<u><b> Array Rules15</b></u><br> ";
$text ="razia@gmail.com";
var_dump(trim($text));
echo"<br>";

echo "<u><b> Array Rules16</b></u><br> ";
$text ="razia@gmail.com";
echo(strlen($text));
echo"<br>";


echo "<u><b> Array Rules17</b></u><br> ";
